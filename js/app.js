...
function handleStudentMarksDisplay() {
    ...
    if (subjectNames === undefined) {
        ...
        for (
            ...
            studentObtainesMarks =
                studentObtainesMarks + +obtainedMarks[i].value;
            studentTotalSubjectMarks =
                studentTotalSubjectMarks + +fullMarks[i].value;
        }
    ...
    let studentPercent =
        (studentObtainesMarks / studentTotalSubjectMarks) * 100;
    if (studentPercent) {
